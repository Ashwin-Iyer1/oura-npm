...
export interface Sleep {
  id: string;
  day: string;
  key: string; // Often useful for lists, though not in spec strictly as 'key', 'id' works.
...
export interface OuraData {
  ...
  sleep_documents: Sleep[]; // Renamed to avoid confusion with DailySleep
  ...
  earliest_date?: string; // Helper for charts
  vo2_max: VO2Max[];
}
